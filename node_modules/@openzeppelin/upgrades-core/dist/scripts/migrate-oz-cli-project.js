...
function migrateManifestsData(manifestsData) {
    ...
    for (const network of Object.keys(manifestsData)) {
        ...
        if (compare_versions_1.compare(manifestVersion, '3.0', '>=')) {
            // no need to migrate
            continue;
        }
        if (manifestVersion !== '2.2') {
            throw new Error(`Migration failed: expected manifest version 2.2, got ${manifestVersion} instead. Update your OpenZeppelin CLI version.`);
        }
